        ...
        >
          ...
          <div className="relative z-10 max-w-2xl mx-auto space-y-6">
            ...
            <p className="text-zinc-600 font-sans font-light text-sm sm:text-base leading-relaxed">
              Ya sea que necesites reels fluidos para Instagram, un rediseño de feed, fotografía de retrato profesional o un sitio web integrado para tu negocio en Costa Rica, tengo un plan diseñado para ti.
            </p>
