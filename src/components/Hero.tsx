        ...
        <div className="lg:col-span-7 flex flex-col justify-center space-y-8">
          ...
          <div className="space-y-4">
            ...
            >
              ...
              producciones cinematográficas fluidas, gestión de redes sociales y el desarrollo 
              de plataformas web a la medida. Basados en {biography.location}
            </motion.p>
          </div>
          ...
          >
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-[10px] sm:text-xs font-semibold tracking-widest uppercase text-zinc-800">WEB DEV</span>
            </div>
          </motion.div>
          ...
          >
            <div className="absolute inset-4 overflow-hidden rounded-none bg-neutral-900 group">
              <img
                ...
                className="w-full h-full object-cover grayscale opacity-75 group-hover:scale-105 transition-transform duration-[4000ms] ease-out select-none"
              />
              ...
              <div className="absolute bottom-6 left-6 right-6 text-white">
                ...
                <h3 className="text-xl font-serif tracking-tight mb-2">PRODUCCIONES CON ALMA</h3>
