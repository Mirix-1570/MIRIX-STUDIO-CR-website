...
import { Sparkles, ArrowRight, Video, Camera, Star, Code, Compass, ArrowUpRight } from 'lucide-react';
                ...
                <section className="bg-white py-24 px-4 sm:px-6 lg:px-8 border-t border-black/10">
                  <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                      ...
                      <div className="p-8 bg-neutral-50 border border-neutral-200/80 rounded-none relative group hover:border-black transition-all duration-300">
                        <div className="flex justify-between items-start mb-6">
                          <span className="text-zinc-400 font-mono text-xs">03 / WEB Y REDES</span>
                          <Code className="w-5 h-5 text-zinc-800" />
                        </div>
                        <h3 className="text-xl font-serif font-bold tracking-tight text-zinc-950 mb-2">Desarrollo & Contenido</h3>
                        <p className="text-xs text-zinc-600 font-sans font-light leading-relaxed mb-4">
                          De la mano con la producción, creamos tu landing page o portafolio web elegante desde cero, con integraciones inteligentes para asegurar prospectos estables y directos.
                        </p>
                        <button
                          onClick={() => setCurrentTab('contact')}
                          className="flex items-center space-x-1.5 text-[10px] font-bold tracking-widest uppercase text-zinc-900 hover:underline cursor-pointer"
                        >
                          <span>Consultar desarrollo</span>
                          <ArrowUpRight className="w-3.5 h-3.5" />
                        </button>
                      </div>
                    </div>
      ...
      <footer className="bg-white border-t border-black/10 py-12 text-zinc-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="text-[10px] text-zinc-450 font-sans text-center md:text-right">
            <span>Diseñado por Miranda Méndez • Esparza, Costa Rica</span>
          </div>
        </div>
      </footer>
